// Cultural form validation and submission
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Ensure service type is always "Cultural"
  const serviceTypeInput = document.getElementById("serviceType");
  serviceTypeInput.value = "Cultural";
      ...
      switch (field.id) {
        ...
        case "functionDate":
          ...
          if (selectedDate < today) {
            isValid = false;
            errorMessage = "Function date cannot be in the past";
          }
          break;
  ...
  form.addEventListener("submit", async function (e) {
    ...
    try {
      ...
      console.log("Cultural booking submitted:", formData);

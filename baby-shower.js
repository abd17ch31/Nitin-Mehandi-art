// Baby Shower form validation and submission
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Ensure service type is always "Baby Shower"
  const serviceTypeInput = document.getElementById("serviceType");
  serviceTypeInput.value = "Baby Shower";
      ...
      switch (field.id) {
        ...
        case "functionDate":
          ...
          if (selectedDate < today) {
            isValid = false;
            errorMessage = "Baby shower date cannot be in the past";
          }
          break;
  ...
  form.addEventListener("submit", async function (e) {
    ...
    try {
      ...
      console.log("Baby Shower booking submitted:", formData);

// Bridal form validation and submission
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Ensure service type is always "Bridal"
  const serviceTypeInput = document.getElementById("serviceType");
  serviceTypeInput.value = "Bridal";
  ...
  inputs.forEach((input) => {
    // Skip readonly service type input
      ...
      switch (field.id) {
        ...
        case "functionDate":
          ...
          if (selectedDate < today) {
            isValid = false;
            errorMessage = "Wedding date cannot be in the past";
          }
          break;
  ...
  form.addEventListener("submit", async function (e) {
    ...
    // Collect form data
    const formData = {
      serviceType: "Bridal", // Always Bridal
    ...
    try {
      ...
      // Reset form (but keep service type as Bridal)
      form.reset();
      serviceTypeInput.value = "Bridal";
      ...
      console.log("Bridal booking submitted:", formData);

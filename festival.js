// Festival form validation and submission
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Ensure service type is always "Festival"
  const serviceTypeInput = document.getElementById("serviceType");
  serviceTypeInput.value = "Festival";
      ...
      switch (field.id) {
        ...
        case "functionDate":
          ...
          if (selectedDate < today) {
            isValid = false;
            errorMessage = "Festival date cannot be in the past";
          }
          break;
  ...
  form.addEventListener("submit", async function (e) {
    ...
    try {
      ...
      console.log("Festival booking submitted:", formData);
